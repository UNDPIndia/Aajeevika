...
<section class="content">
      ...
      @if ($errors->any())
        ...
        @endif
          ...
          <div class="card-body">
            <form enctype="multipart/form-data" action="{{ url('admin/addbanner') }}" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="text" class="form-control" name="action" id="" placeholder="http://www.example.com">
                    </div>
