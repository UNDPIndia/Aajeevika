    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Bulk Email (This manager is to manage Bulk Email for User, SHG and Artisans.)</h3>
            ...
            <a href="{{ url('admin/sendbulkmessage') }}" class="btn btn-outline-primary float-sm-right">Send Bulk Message</a> --}}
                ...
                <a href="{{ url('admin/addEmailbulk') }}" class="btn btn-outline-primary float-sm-right">Send New Bulk
                    Email</a>
            </div>
            <div class="card-body">
