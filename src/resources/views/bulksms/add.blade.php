...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form id="notify_form" enctype="multipart/form-data" action="{{ url('admin/addbulk') }}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 form-group">
                            <label for="">Message Body (100 chars only) *</label>
                            <textarea maxlength="100" class="form-control" name="message" id=""
