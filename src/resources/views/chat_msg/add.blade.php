@extends('layouts.app')
@section('title', 'Chat Messages | UNDP')
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" action="{{ url('admin/add-chat-message') }}" method="post">
                    @csrf
                    <div class="row">

                        <div class="col-sm-6 form-group">
                            <label for="">Message English * : </label>
                            <input type="text" class="form-control" name="msg_en" id="">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label for="">Message Hindi * : </label>
                            <input type="text" class="form-control" name="msg_hi" id="">
                        </div>
