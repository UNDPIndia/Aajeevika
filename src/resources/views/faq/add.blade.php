    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" action="{{ url('admin/addfaq') }}" method="post">
                    @csrf
                    <div class="row">

                        <div class="col-sm-6 form-group">
                            <label for="">Topic English * : </label>
                            <input type="text" class="form-control" name="topic_en" id="">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label for="">Topic Hindi * : </label>
                            <input type="text" class="form-control" name="topic_hi" id="">
                        </div>
