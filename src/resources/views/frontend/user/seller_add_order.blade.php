    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="col-12 text-center d-none" id="spinner">
                ...
                {{Session::get('weblangauge') == 'kn' ? '':''}}Loading...
                </button>
            </div>
                        ...
                        <div class="topPart">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <label class="w-100">{{Session::get('weblangauge') == 'kn' ? 'रुचि आईडी':'Interest ID'}}</label>
                                        @php
                                            $sess_interest_id = 0;
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="" id="buyer_name" placeholder="{{Session::get('weblangauge') == 'kn' ? 'खरीदार का नाम':'Name of Buyer'}}" value="@if(Session::has('sess_buyer_name')){{ Session::get('sess_buyer_name') }} @endif" readonly/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="">{{Session::get('weblangauge') == 'kn' ? 'वितरण का तरीका':'Mode of Delivery'}}</label>
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <input type="radio" name="mode_of_delivery" id="self" value="0"  @if(Session::has('sess_mod') && Session::get('sess_mod') == 0) checked @endif/>
                                                <label for="self" class="radioLable">{{Session::get('weblangauge') == 'kn' ? 'स्वयं':'Self'}}</label>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <input type="radio" name="mode_of_delivery" id="c-centre" value="1" @if(Session::has('sess_mod') && Session::get('sess_mod') == 1) checked @endif/>
                                                <label for="c-centre" class="radioLable">{{Session::get('weblangauge') == 'kn' ? 'संग्रहण केंद्र':'Collection Centre'}}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 collection_box">
                                    <div class="form-group">
                                    <label>{{Session::get('weblangauge') == 'kn' ? 'संग्रहण केंद्र':'Collection Centre'}}</label>
                                        <div class="custom-field">
                                            <select class="form-control" name="collection_center_id">
                                                ...
                                                @empty
                                                    <option value="">{{Session::get('weblangauge') == 'kn' ? 'संग्रहण केंद्र उपलब्ध नहीं है':'Collection Center Not Available'}}</option>
                                                @endforelse
                        ...
                        <div class="bottomPart">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="salesDate">
                                            ...
                                            <input data-date-format="yyyy-mm-dd" name="sale_date" class="form-control" id="date_sale" value="{{date('Y-m-d')}}" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-12 col-md-6" id="del_product_{{$sproduct_session['id']}}">
                                                        <div class="prodCard d-flex justify-content-between align-items-center">
                                                            <div class="left-part d-flex flex-wrap align-content-center justify-content-start">
                                                                    ...
                                                                    <div class="pricetag w-100">{{Session::get('weblangauge') == 'kn' ? 'कीमत:':'Price:'}} <b>{{ $sproduct_session['price'] ?  $sproduct_session['price'] :'' }}/{{ $sproduct_session['price_unit'] ?  $sproduct_session['price_unit'] : '' }}</b></div>
                                                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="addProduct">
                                    <a href="{{url('/seller-products')}}/{{encrypt($seller_id)}}" id="addProduct">{{Session::get('weblangauge') == 'kn' ? 'उत्पाद जोड़ें':'Add Products'}}</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea name="review_msg" id="" class="form-control" placeholder="{{Session::get('weblangauge') == 'kn' ? 'खरीदार के लिए प्रतिक्रिया':'Feedback for buyer'}}" required >{{old('review_msg')}}</textarea>
                                    </div>
                                </div>
