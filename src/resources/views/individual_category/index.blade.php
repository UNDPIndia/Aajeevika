    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title">Ind Category ( This Manager is to manage Ind Categories )</h3>
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="{{ url('admin/indcategory/addcategory') }}" class="btn btn-outline-primary float-sm-right">
                            Add New Ind Category
                        </a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($categoryData as $item)
                                    ...
                                    <tr>
                                        ...
                                        <!--    <a href="{{ url('admin/viewcategory') }}/{{ $item->id }}"
                                            ...
                                            <a href="{{ url('admin/indcategory/editcategory') }}/{{ $item->id }}"
                                            ...
                                            @if ($item->status == 0)
                                                <a onclick="return confirm('Are you sure?')"
                                                    href="{{ url('admin/indcategory/deletecategory') }}/{{ $item->id }}/1"
                                                    class="btn btn-success btn-sm">Enable</a>
                                            @else
                                                <a onclick="return confirm('Are you sure?')"
                                                    href="{{ url('admin/indcategory/deletecategory') }}/{{ $item->id }}/0"
