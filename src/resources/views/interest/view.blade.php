@extends('layouts.app')
@section('title', 'Interest Management | UNDP')
@section('content')
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Interest View ( This Manager is to manage interest.)</h3>
                        ...
                        <tbody>
                            ...
                            @foreach ($allorder[0]->items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->quantity }}</td>  
                                    <td>Rs. {{ $item->quantity  *  $item->product->price }}
                                        @php
                                            $ttlPrice += ($item->quantity  *  $item->product->price);
                                        @endphp
                                    </td> 
                                </tr>
                                @php
