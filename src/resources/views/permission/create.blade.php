...
<section class="content">
      ...
      @if ($errors->any())
        ...
        @endif
          ...
          <div class="card-body">
            <form enctype="multipart/form-data" action="{{ url('admin/addpermission') }}" method="post">
                @csrf
                <div class="row">

                    <div class="col-sm-6 form-group">
                        <label for="">Permission Name : </label>
                        <input type="text" class="form-control" placeholder="Permission Name" name="permission_name" id="" required>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="">Url : </label>
                        <input type="text" class="form-control" name="url" placeholder="URL" id="" required>
                    </div>
